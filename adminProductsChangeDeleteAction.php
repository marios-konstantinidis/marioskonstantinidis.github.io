   ...
   <?php 
	...
	// Was the Amend presed 
		...
		{ 
         ...
         $sql = "UPDATE $tbl_stock SET stockid = '$stockid', stockname = '$stockname', stockquantity = '$stockquantity', stocktype = '$stocktype', stocksell= '$stocksell' WHERE stockid = '$stockid'";
...
<p><a href="adminAddProduct.php">Add new Product</a></p> 
