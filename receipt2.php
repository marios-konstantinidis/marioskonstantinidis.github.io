...
<div class="content_box">
 ...
 <?php
	...
	$overallCost = 0.00;
	$deliveryCharge = 0.00;
	$orderID = $_SESSION['receipt_array']['order_id'];
	$deldate = $_SESSION['receipt_array']['del_date'];
	
	echo "<div class='contentBox'><h1>Your Receipt</h1><p>Your order has been processed. Below is your receipt. Thanks for your shopping.</p><br /><table class='menuTable' summary='Menu Table'>";
	...
	while ($row = mysql_fetch_array($result))
	{
		...
		$quantity = $_SESSION['receipt_array'][$id];
		
		if (($quantity !=0) || ($quantity !=''))  {
		
			$overallCost += $price * $quantity;
			echo "<tr><td class='productID' >$id.</td><td class='productName' >$product</td><td class='productPrice' >&pound;$price</td><td class='productSelection' >$quantity</td></tr>";
		}
	}
	
	echo "</table><div id='checkoutinfo' ><br /><label>To Be Delivered:</label><label class='checkoutlabel'>$deldate</label><br />
	<label class='bold'>Total Cost:</label><label id='totalcost' class='checkoutlabel'>&pound;$overallCost</label><br/></div></div>";
