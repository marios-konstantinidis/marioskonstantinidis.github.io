...
<div class="content_box">
  ...
  <?php
$connection = mysql_connect("mysql11.000webhost.com", "a2544598_actech", "maddogskate2") or die(mysql_error());
...
// create query 
$query = "SELECT * FROM $tbl_stock WHERE stockid = '$stockid'"; 
...
?> 
<form name="form1" id="form1" method="GET" action= "adminProductsChangeDeleteAction.php"> 
<table width="100%"  border="0"> 
        <tr> 
          <td width="25%">Product id: </td> 
          <td width="75%"><input type="hidden" name="stockid" value="<?php echo $row["stockid"]; ?>" /><?php echo $row["stockid"]; ?><font size="2"> (Field hidden as cannot change key field)</font></td> 
        </tr> 
        <tr> 
          <td>Product Name</td> 
          <td><input type="text" name="stockname" value="<?php echo $row["stockname"]; ?>"/></td> 
        </tr> 
        <tr> 
          <td>Product Price</td> 
          <td><input type="text" name="stocksell" value="<?php echo $row["stocksell"]; ?>"/></td> 
        </tr>
        <tr> 
          <td>Product Quantity</td> 
          <td><input type="text" name="stockquantity" value="<?php echo $row["stockquantity"]; ?>"/></td> 
        </tr>  
		<tr> 
          <td>Product Type</td> 
          <td><input type="text" name="stocktype" value="<?php echo $row["stocktype"]; ?>"/></td> 
        </tr>
        <tr><td><input name="Amend" type="Submit" value="Change" /></td><td><input name="Delete" type="Submit" value="Delete" /></td></tr> 
      </table> 
    </form> 
