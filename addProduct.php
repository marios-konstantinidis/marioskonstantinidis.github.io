...
$query = "INSERT INTO $tbl_stock ( stockname, stockquantity, stocktype, stocksell) VALUES ('$stockname', '$stockquantity', '$stocktype', 'stocksell')";     

$result = mysql_query($query) or die ("Error in query: $query. ".mysql_error());  
print "<br />A new product inserted into the database";    
   ...
   // print message with ID of inserted record 
    ...
    while($row = mysql_fetch_array($result)) { 
		...
		echo "<td>".$row['stocksell']."</td>"; 
        echo "<td>".$row['stocktype']."</td>"; 
		echo "<td><a href=ProductChangeDelete.php?stockid=".$row[stockid].">Change/Delete</a></td>";
        echo "</tr>"; 
    } //End while
    echo "</table>"; 
...
<p> <a href = "adminProducts.php"> Back to Products</a></p>
 </div>           
