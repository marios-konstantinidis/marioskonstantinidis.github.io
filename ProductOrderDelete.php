  ...
  <div id="catalogue">
   ...
   <?php 
	...
	// Was the Amend presed 
     		...
     		$query = "DELETE FROM $tbl_custorder WHERE orderid = '$orderid'"; 
      		if (!($result = @ mysql_query ($query, $connection))) die("No records deleted"); 
   			//Check the number of affected rows 
    		if(mysql_affected_rows()==1) 
   			{ 
     		 //Deletion ran OK 
       			echo "The Product with ID = $orderid was deleted<br>"; 
   			...
   			{ 
     		//Failed to delete 
       		echo "Could not delete product with ID = $orderid "; 
   			} 
...
<p> <a href = "ProductOrder.php"> Back to Products Orders</a></p>
</div>           
